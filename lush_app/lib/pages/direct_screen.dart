...
import 'package:lush_app/features/chat/presentation/widgets/send_message_widget.dart';
...
class _DirectScreenState extends State<DirectScreen> {
  ...
  void _updateReplyMessage(Message message) {
  ...
  Future<String> _getOtherUserName(Chat chat) async {
    ...
    return const Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          LushTokensWidget(
            viewModel: LushTokensWidgetViewModel(),
          ),
        ],
      ),
    );
  ...
  Widget _buildContactBar(BuildContext context, Chat chat) {
    return Padding(
        ...
        child: Column(
          children: [
            ...
            repliedMessage != null
                ...
                : Container(),
            SendMessageWidget(
              viewModel: SendMessageWidgetViewModel(),

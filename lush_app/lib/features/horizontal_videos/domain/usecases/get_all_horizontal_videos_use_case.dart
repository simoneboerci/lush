...
class GetAllHorizontalVideosUseCase
    implements UseCase<List<HorizontalVideo>, GetAllHorizontalVideosParams> {
  final HorizontalVideoRepository horizontalVideoRepository;

  const GetAllHorizontalVideosUseCase(this.horizontalVideoRepository);

  @override
  Future<Either<Failure, List<HorizontalVideo>>> call(
      GetAllHorizontalVideosParams params) async {
    return await horizontalVideoRepository.getAllVideos();
  }
}

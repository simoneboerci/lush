...
import 'package:lush_app/features/auth/presentation/viewmodels/verification/third_step_verification_screen_view_model.dart';
...
class ThirdStepVerificationScreen extends StatelessWidget {
  final ThirdStepVerificationScreenViewModel viewModel =
      ThirdStepVerificationScreenViewModel();
  ...
  FormWidgetViewModel _createFormWidgetViewModel(
    ...
    return FormWidgetViewModel(
      ...
      primaryButtonText: 'Richiedi Verifica',
      primaryButtonOnPressed: () =>
          viewModel.onThirdStepCompletedButtonOnPressed(context, currentUserId),
      primaryButtonBackgroundColor: cSecondaryColor,
      primaryButtonTextColor: cSurfaceColor,
      useTextButton: true,
      textButtonText: 'Passaggio 3 di 3',
    );
  }
      ...
      listeners: [
        ...
        BlocListener<UserBloc, UserState>(
          listener: (context, state) {
            ...
            } else if (state is UserThirdStepVerificationCompletedState) {
              viewModel.goToVerificationCompletedScreen(context);
            }
          },
        ),
      ],
          ...
          if (authState is AuthOnLoadingCurrentUserState) {
            ...
            return BlocBuilder<UserBloc, UserState>(
              builder: (context, userState) {
                ...
                } else if (userState is UserOnThirdStepVerificationState) {
                  return const CustomLoader();
                }
  ...
  List<Widget> _getTextFields() {
    return [
      CustomTextField.large(
        ...
        controller: viewModel.fiscalCodeController,
        validator: viewModel.validateFiscalCode,
      ),
    ];
  }
}
